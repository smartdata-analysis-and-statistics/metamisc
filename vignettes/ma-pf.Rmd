...
The probability is `r `sprintf("%.0f%%", probOS*100)`%, suggesting that using HER2 will often provide adequate discrimination.
...
kout <- out %>% mutate(logHR =  sprintf("%.3f", logHR),
  ...
  select(outcome, model, logHR, logHR.se, HR, HRci)
kable(kout, col.names = c("Outcome", "Model", "log HR", "SE", "HR", "95% CI"),
      align = "llccc")
```
